...
```text
0570 docs -> 0580 dry-run loop -> 0590 stable publish runner -> 0600 risk gate -> 0610 risk integration -> 0620 independent review -> 0630 controlled executor -> 0640 e2e dry run -> 0650 controlled write pilot
```
...
Il classifier e' ancora separato dal runner 0580.
