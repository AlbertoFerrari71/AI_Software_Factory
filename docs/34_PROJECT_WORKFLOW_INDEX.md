...
- `scripts/asf_publish_step.ps1`: runner STEP 0590/0640/0810 per `PrepareConfig` e FASE A/B/C di pubblicazione step con comando corto, config JSON, Bridge output, flag espliciti, scope discovery/recovery e validazione opzionale del verification profile.
