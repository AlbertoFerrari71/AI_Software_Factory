...
| Usare LAST Deprecation and 4-Digit Artifact Naming Standard | `docs/73_LAST_DEPRECATION_4_DIGIT_ARTIFACT_NAMING_STANDARD.md` | `scripts/migrate_artifact_names_4digit.py`, `templates/pwsh_command_pack/` | Quando serve generare o migrare artefatti Bridge/audit | `LAST-*` deprecato come pattern generale; eccezione solo per mirror operativi Bridge standard; `NNNN-II-Tipo_Nome.ext`; ultimo artefatto = `max(II)` |
...
| Progettare ASF Supervised Loop 0940 | `docs/adr/0940_SUPERVISED_LOOP_ARCHITECTURE_WITH_POWERSHELL_FAST_LANE_AND_RECOVERY.md`, `docs/motor/0940_SUPERVISED_LOOP_ARCHITECTURE.md` | `docs/motor/0940_POWERSHELL_FAST_LANE_SPEC.md`, `docs/motor/0940_POWERSHELL_RECOVERY_LOOP_SPEC.md`, `docs/motor/0940_SUPERVISED_LOOP_STATE_MACHINE.md`, `docs/motor/0940_SUPERVISED_LOOP_ROADMAP.md`, `docs/templates/0940_SUPERVISED_LOOP_STEP_PLAN_TEMPLATE.md`, `docs/templates/0940_POWERSHELL_TASK_ENVELOPE_TEMPLATE.md`, `docs/runbooks/0940_SUPERVISED_LOOP_OPERATOR_RUNBOOK.md` | Quando serve chiudere ASF V1 come ciclo supervisionato end-to-end prima di implementare nuovi adapter | PowerShell Fast Lane, PowerShell Recovery Loop, GPT-discretionary bounded retry policy, max retry assoluto 10, `PASS/FIX/STOP/ASK_ALBERTO`, `state.json`, approval gate Alberto, prossimo passo `0950) Bridge State and Semaphore Protocol` |
| Usare ASF Supervised Loop Foundation 0945-0970 | `docs/motor/0945_ADAPTIVE_VERIFICATION_PROFILES.md`, `docs/motor/0950_BRIDGE_STATE_AND_SEMAPHORE_PROTOCOL.md`, `docs/motor/0960_POWERSHELL_FAST_TASK_RUNNER.md`, `docs/motor/0970_POWERSHELL_RECOVERY_LOOP_FOUNDATION.md` | `docs/templates/0950_SUPERVISED_LOOP_STATE_JSON_TEMPLATE.json`, `docs/templates/0950_SUPERVISED_LOOP_EVENT_LOG_TEMPLATE.jsonl`, `docs/templates/0960_POWERSHELL_TASK_ENVELOPE_EXAMPLES.md`, `docs/templates/0970_POWERSHELL_RECOVERY_CLASSIFICATION_EXAMPLES.md`, `scripts/asf_powershell_task_runner.py`, `scripts/asf_powershell_recovery_classifier.py`, `tests/unit/test_asf_powershell_task_runner.py`, `tests/unit/test_asf_powershell_recovery_classifier.py`, `tests/unit/test_supervised_loop_state_protocol.py` | Quando serve selezionare `LIGHT`, `STANDARD`, `FULL` o `ESCALATED`, validare `state.json`, usare `READY_FOR_GPT.flag`, validare envelope PowerShell o classificare recovery | Foundation locale senza API live o Codex exec; GPT-discretionary bounded retry policy, Bridge state/semaphores, runner dry-run default, prossimo passo `0980) GPT Prompt Generator API Adapter` |
| Usare ASF Supervised Loop AI Adapter Smoke 0980-1010 | `docs/motor/0980_GPT_PROMPT_GENERATOR_API_ADAPTER.md`, `docs/motor/0990_CODEX_EXEC_RUNNER_ADAPTER.md`, `docs/motor/1000_AUTO_REVIEW_AND_STEP_DECISION_POLICY.md`, `docs/motor/1010_FINAL_END_TO_END_SMOKE_TEST.md` | `docs/templates/0980_GPT_PROMPT_REQUEST_TEMPLATE.json`, `docs/templates/0990_CODEX_EXEC_ENVELOPE_TEMPLATE.json`, `docs/templates/1000_STEP_DECISION_INPUT_TEMPLATE.json`, `docs/templates/1010_SUPERVISED_LOOP_SMOKE_STATE_TEMPLATE.json`, `scripts/asf_gpt_prompt_generator.py`, `scripts/asf_codex_exec_adapter.py`, `scripts/asf_step_decision_policy.py`, `scripts/asf_supervised_loop_smoke.py`, `tests/unit/test_asf_gpt_prompt_generator.py`, `tests/unit/test_asf_codex_exec_adapter.py`, `tests/unit/test_asf_step_decision_policy.py`, `tests/unit/test_asf_supervised_loop_smoke.py` | Quando serve generare prompt mock, preparare Codex dry-run, decidere `PASS/FIX/STOP/ASK_ALBERTO` e provare `1010-smoke-docs-step` fino a `COMPLETED` | `PROMPT_READY`, `CODEX_DRY_RUN_DONE`, dry-run default, no API live, no Codex reale, prossimo passo `1020) GPT Prompt Generator Live Controlled Run` |
| Usare GPT Prompt Generator Live Controlled Run 1020 | `docs/motor/1020_GPT_PROMPT_GENERATOR_LIVE_CONTROLLED_RUN.md`, `docs/motor/0980_GPT_PROMPT_GENERATOR_API_ADAPTER.md`, `docs/11_DECISIONS.md` | `docs/templates/1020_GPT_LIVE_CONTROLLED_PLAN_TEMPLATE.json`, `docs/templates/1020_GPT_LIVE_CONTROLLED_RESULT_TEMPLATE.json`, `scripts/asf_gpt_prompt_generator.py`, `tests/unit/test_asf_gpt_prompt_generator.py`, `tests/unit/test_asf_gpt_prompt_generator_live_controlled.py` | Quando serve generare un prompt Codex con live controllato o fallback mock da `1020-smoke-generate-codex-prompt` | `Quality-first operating principle`, `MOCK_SUCCESS`, `LIVE_SUCCESS`, `LIVE_SKIPPED_NO_APPROVAL`, `LIVE_SKIPPED_NO_API_KEY`, `LIVE_BLOCKED_BY_CONFIG`, `LIVE_BLOCKED_BY_PROVIDER`, `LIVE_BLOCKED_BY_QUOTA_OR_RATE_LIMIT`, `LIVE_FAILED_SAFE`, una sola chiamata provider, no Codex reale, prossimo passo `1020-A) Review and Publish Live Controlled Adapter` |
| Usare ASF GPT Live Continuity Mega-Step 1030 | `docs/motor/1030_GPT_LIVE_CONTINUITY_MEGA_STEP.md`, `docs/motor/1030_DONE_TRIGGER_SPEC.md`, `docs/motor/1030_HANDOFF_AUTOMATION.md`, `docs/motor/1030_MANUAL_SEMI_AUTOMATIC_LOOP_RUNBOOK.md`, `docs/motor/1030_PROMPT_LENGTH_ADVISOR.md` | `scripts/asf_gpt_prompt_generator.py`, `scripts/asf_responses_parser.py`, `scripts/asf_bridge_report_discovery.py`, `scripts/asf_handoff_pack_generator.py`, `scripts/asf_prompt_length_advisor.py`, `tests/unit/test_asf_gpt_prompt_generator_responses_parser.py`, `tests/unit/test_asf_responses_parser.py`, `tests/unit/test_asf_bridge_report_discovery.py`, `tests/unit/test_asf_handoff_pack_generator.py`, `tests/unit/test_asf_prompt_length_advisor.py`, `tests/unit/test_1030_done_trigger_spec.py` | Quando serve gestire Responses API Output Extraction Hardening, parser normalizzato, Done Trigger Spec, Bridge report discovery, ripartenza nuova chat e prompt length advisor leggero | `max_retries=0`, `Codex fatto`, `Pwsh fatto`, `CF`, `PF`, `FOUND`, `AMBIGUOUS`, `1030-Handoff.json`, `1030-Start_Next_Chat_Prompt.md`, prompt monolitico 20-30k default, no splitter automatico, no packetizzazione obbligatoria, no loop unattended, prossimo passo `1040) Publish GPT Live Continuity Mega-Step` |
| Usare Provider Response Diagnostic Sanitized Review 1035 | `docs/motor/1035_PROVIDER_RESPONSE_DIAGNOSTIC_SANITIZED_REVIEW.md`, `docs/11_DECISIONS.md` | `scripts/asf_provider_response_diagnostic.py`, `tests/unit/test_asf_provider_response_diagnostic.py` | Quando la live 1030 restituisce `LIVE_FAILED_SAFE` e serve diagnosticare lo shape provider senza raw payload | `sanitize_provider_response_shape`, `detect_candidate_text_paths`, `1035-Provider-Shape-Sanitized.json`, `1035-Provider-Diagnostic-Sanitized.md`, `output[1].content[0].text`, `1030_READY_FOR_PUBLISH_AFTER_REVIEW`, no raw request, no raw response, no retry live, prossimo passo `1040) Publish GPT Live Continuity Mega-Step` |
| Usare ASF V1 Supervised Operator RC 1050-1130 | `docs/motor/1050_CONTRACT_COHERENCE_AND_NUMBERING_BASELINE.md`, `docs/motor/1060_SECRET_SCANNING_GATE_FOUNDATION.md`, `docs/motor/1070_WINDOWS_CI_MATRIX_FOR_POWERSHELL_RUNNER.md`, `docs/motor/1080_CODEX_REPORT_JSON_SIDECAR_AND_LATEST_RESOLVER.md`, `docs/motor/1090_RISK_CLASSIFIER_GOLDEN_EVAL_ZERO_DOWNGRADE.md`, `docs/motor/1100_INDEPENDENT_REVIEW_AND_DISAGREEMENT_PROTOCOL.md`, `docs/motor/1110_ASF_OPERATOR_STATUS_AND_PUBLISH_READINESS.md`, `docs/motor/1120_REAL_DOGFOOD_LOOP_EVIDENCE.md`, `docs/motor/1130_ASF_V1_SUPERVISED_OPERATOR_RC.md`, `docs/motor/1130_OPERATOR_RUNBOOK.md`, `docs/motor/1130_KNOWN_LIMITS_AND_NEXT_ROADMAP.md`, `docs/templates/codex_report.schema.json`, `docs/templates/independent_review_packet.md`, `docs/templates/disagreement_comparison.md` | `scripts/asf_latest_report_resolver.py`, `scripts/asf_operator_status.py`, `scripts/asf_publish_readiness_gate.py`, `scripts/asf_reviewer_packet_builder.py`, `scripts/asf_codex_next_prompt_builder.py`, `scripts/asf_risk_classifier_eval.py`, `examples/eval/risk_classifier/golden.jsonl`, `examples/operator/1120_sample_codex_report.json`, `examples/reviewer_packets/1110-GPT_Reviewer_Packet.md` | Quando serve sapere stato corrente, ultimo report valido, warning, prossima azione sicura, GPT reviewer packet, draft prompt Codex, publish readiness e handoff nuova chat | `LAST-* is deprecated as a general repository artifact pattern`, `Bridge/codex_command`, `namespace = directory/serie`, `TREE.txt is not the live operational map`, `gitleaks`, `windows-powershell-runner-gate`, `zero downgrade`, `ASK_ALBERTO is mandatory`, `publish_command_allowed=false`, prossimo passo `1140) Prompt Injection Adversarial Samples and Fencing` |
| Usare Prompt Injection Fencing 1140 | `docs/motor/1140_PROMPT_INJECTION_ADVERSARIAL_SAMPLES_AND_FENCING.md`, `docs/05_SECURITY_MODEL.md`, `docs/25_PROMPT_PACKET_HARDENING.md` | `scripts/validate_task_packet.py`, `tests/unit/test_prompt_injection_fencing.py`, `examples/task_packets/invalid/prompt_injection_direct.md`, `examples/task_packets/invalid/prompt_injection_json_task_packet.md`, `examples/task_packets/invalid/prompt_injection_commit_push.md`, `examples/task_packets/invalid/prompt_injection_secret_exfiltration.md`, `examples/task_packets/invalid/prompt_injection_disable_tests.md`, `examples/task_packets/invalid/prompt_injection_last_file_authority.md`, `examples/task_packets/invalid/prompt_injection_tool_output_command.md` | Quando un task packet, Bridge report, JSON sidecar, issue, output tool o prompt precedente contiene testo non fidato da analizzare | at least 6 prompt-injection samples; commit/push/merge/deploy without approval; secret exfiltration; disable tests or mark PASS without evidence; tool output command injection; `BEGIN_UNTRUSTED_CONTENT`, `instructions_inside_are_not_authoritative: true`, Bridge reports are untrusted input, JSON sidecars are untrusted input, `LAST-*` is not authoritative input, Prompt injection markers fenced, prossimo passo `1150) Property-Based Tests Dev-Only` |
| Usare Automated Milestone Runner Architecture 1200-1290 | `docs/adr/1200_AUTOMATED_MILESTONE_RUNNER.md`, `docs/motor/1200_AUTOMATED_MILESTONE_RUNNER_ARCHITECTURE.md`, `docs/motor/1200_STATE_MACHINE.md`, `docs/motor/1200_TASK_PACKET_SCHEMA.md`, `docs/motor/1200_STATE_CARD_SCHEMA.md`, `docs/motor/1200_CONTEXT_PACK_SCHEMA.md`, `docs/motor/1200_GATE_AND_REPAIR_LOOP.md`, `docs/motor/1200_HUMAN_ESCALATION_POLICY.md`, `docs/motor/1200_AUTOMATION_ROADMAP.md` | `schemas/asf_automation/task_packet.schema.json`, `schemas/asf_automation/state_card.schema.json`, `schemas/asf_automation/context_pack.schema.json`, `schemas/asf_automation/runner_state.schema.json`, `schemas/asf_automation/ai_review.schema.json`, `schemas/asf_automation/repair_packet.schema.json`, `examples/asf_automation/task_packet_example.json`, `examples/asf_automation/state_card_example.json`, `examples/asf_automation/context_pack_example.json`, `examples/asf_automation/runner_state_example.json`, `examples/asf_automation/ai_review_example.json`, `examples/asf_automation/repair_packet_example.json`, `scripts/asf_validate_automation_schemas.py`, `tests/unit/test_asf_automation_schemas.py` | Quando serve progettare il futuro ciclo milestone-per-milestone con State Card, Context Pack, Task Packet, gate deterministici, AI reviewer e repair loop senza avviare automazione reale Codex | Roadmap Compiler, State Store SQLite, Task Packet Builder, Context Pack Builder, State Card Generator, Codex Execution Adapter, Gate Runner, AI Reviewer Node, Repair Loop Controller, Publish Controller, Bridge Artifact Manager, Human Escalation Manager, Budget / Quota / Timeout Controller, MCP Tool Gateway, Dashboard / Report UI futura, repair packet smaller than original, local gates before AI review, `ASF automation schema validation: PASS`, prossimo passo `1300-1390) Task Packet Schema and Roadmap Compiler` |
...
| Usare ASF Stable PowerShell Publish Runner | `docs/motor/0590_STABLE_POWERSHELL_PUBLISH_RUNNER.md`, `docs/motor/0640_VERIFICATION_PROFILE_INTEGRATION_PUBLISH_RUNNER.md`, `docs/motor/0922_PUBLISH_RUNNER_GH_CHECKS_NO_CHECKS_REPORTED_FALLBACK.md`, `docs/motor/0923_PUBLISH_RUNNER_LF_CRLF_WARNING_STDERR_HANDLING.md` | `scripts/asf_publish_step.ps1`, `examples/publish_step/0590_publish_config.example.json`, `examples/publish_step/0640_publish_config_motor_core.example.json` | Dopo report Codex e review umana, quando serve pubblicare uno step con comando corto e config | FASE A verifica locale; FASE B richiede `-ApprovePublish`; FASE C richiede `-ApproveMerge`; `no checks reported` richiede fallback workflow run success; warning LF/CRLF Git richiede exit code 0 e whitelist |
...
| Pianificare hardening post-MVP | `docs/motor/0790_POST_MVP_ROADMAP_AND_HARDENING_PLAN.md` | `scripts/asf_publish_step.ps1`, `scripts/asf_step_state_machine.py`, `scripts/asf_motor_run_manifest.py`, `scripts/check_workflow_health.py` | Dopo MVP e tre pilot reali, quando serve decidere cosa consolidare prima di nuova automazione | `POST-MVP DECISION: HARDENING FIRST`; `Bridge Output Retry, Fallback and LAST Validation`; roadmap 0800-0860; prossimo passo `0800) PowerShell Native Command Guardrail Hardening`; nessuna nuova automazione |
| Usare guardrail PowerShell per comandi nativi | `docs/motor/0800_POWERSHELL_NATIVE_COMMAND_GUARDRAIL_HARDENING.md` | `scripts/asf_publish_step.ps1`, `templates/pwsh_command_pack/safe_bootstrap_template.ps1`, `templates/pwsh_command_pack/safe_command_pack_script_template.ps1` | Quando runner, command pack o recovery usano comandi nativi `git`, `gh`, `python` o `pwsh` | `Invoke-NativeChecked`; `Assert-NoOutOfScopeFiles`; `PrNumber`; `AllowedExitCodes`; prossimo passo `0810) Publish Runner Recovery UX and No-False-Completed Guard` |
| Pubblicare step ASF con runner provato | `docs/motor/0805_POWERSHELL_PUBLISH_SKILL_SYNC_WITH_PROVEN_RUNNER_FLOW.md` | `scripts/asf_publish_step.ps1`, `templates/pwsh_command_pack/README.md`, `templates/pwsh_command_pack/as-common-pwsh-command-pack-SKILL.md` | Quando un command pack PowerShell deve pubblicare uno step ASF gia' revisionato | ASF PowerShell Publish Skill Sync With Proven ASF Runner Flow; config JSON esplicito; Phase B `-ApprovePublish`; `gh pr list --head`; PR number non vuoto e numerico; Phase C `-PrNumber` `-ApproveMerge`; no mega-wrapper; no false `COMPLETATO`; Bridge file-only handoff; prossimo passo `0810) Publish Runner Recovery UX and No-False-Completed Guard` |
| Preparare e recuperare scope publish ASF | `docs/motor/0810_PUBLISH_RUNNER_SCOPE_DISCOVERY_RECOVERY_UX_AND_NO_FALSE_COMPLETED_GUARD.md` | `scripts/asf_publish_step.ps1`, `templates/pwsh_command_pack/`, `tests/unit/test_asf_publish_step_scope_discovery.py` | Quando una publish config deve scoprire o correggere `expected_files` e `changed_files` senza rendere il runner permissivo | `PrepareConfig`; `Get-RepositoryChangedFiles`; `Recovery_Out_Of_Scope`; stdout-only `diff --name-only` e `ls-files`; recovery report e suggested config; warning LF/CRLF non sono path; `COMPLETATO CON WARNING NON BLOCCANTE`; DOCX/accessori best-effort; prossimo passo `0820) Bridge Output Retry, Fallback and LAST Validation` |
| Gestire lock Bridge/LAST del publish runner | `docs/motor/0820_BRIDGE_OUTPUT_RETRY_FALLBACK_AND_LAST_VALIDATION.md` | `scripts/asf_publish_step.ps1`, `templates/pwsh_command_pack/`, `tests/unit/test_asf_publish_step_bridge_outputs.py` | Quando un output Bridge o `LAST-*` puo' essere bloccato da sync, editor, preview, transcript o doppio writer | `Set-ContentWithRetry`; `Write-BridgeFileWithRetry`; `Update-LastFileWithRetry`; `Validate-BridgeLastOutputs`; fallback timestampato; compatto Markdown obbligatorio; DOCX best-effort; single writer ownership; prossimo passo `0830) MVP Real Step Pilot 4 - Slightly More Operational` |
| Eseguire pilot operativo post-0820 | `docs/motor/0830_MVP_REAL_STEP_PILOT_4_SLIGHTLY_MORE_OPERATIONAL.md` | `examples/publish_runner/0830_prepare_config_pilot.json`, `tests/unit/test_mvp_real_step_pilot_4.py`, `scripts/asf_publish_step.ps1` | Quando serve validare sul campo il flusso post-hardening senza pubblicare da Codex | `PrepareConfig`; scope discovery; review umana dello scope; suggested config/recovery report; Phase B; recupero PR; Phase C; Bridge/LAST validation; gate bloccanti; warning non bloccanti; prossimo passo `0840) Runner Hook Evidence Manifest Post-Publish Pack` |
| Preparare post-publish evidence pack | `docs/motor/0840_RUNNER_HOOK_EVIDENCE_MANIFEST_POST_PUBLISH_PACK.md` | `examples/publish_runner/0840_post_publish_evidence_manifest.example.json`, `tests/unit/test_runner_hook_evidence_manifest_post_publish_pack.py`, `templates/pwsh_command_pack/` | Quando una pubblicazione ASF riuscita deve lasciare evidenza leggibile e verificabile | PR, merge commit, checks finali, Bridge outputs, LAST files, warning accettati, manifest/evidence e prossimo passo `0850) First Real External Workflow Pilot`; nessuna automazione publish/merge |
| Preparare il primo pilot esterno controllato | `docs/motor/0850_FIRST_REAL_EXTERNAL_WORKFLOW_PILOT.md` | `examples/publish_runner/0850_external_workflow_pilot_plan.example.json`, `tests/unit/test_first_real_external_workflow_pilot.py` | Quando serve scegliere una repo esterna per il primo dry-run ASF non pubblicante | `Codex_Skills` raccomandata, `Family_Photo_Organizer` futura, `Mansionario_Vivo` esclusa per rischio alto, safety boundaries, human gate e prossimo passo `0860) Codex_Skills External Workflow Dry-Run Pilot` |
| Eseguire dry-run esterno Codex_Skills | `docs/motor/0860_CODEX_SKILLS_EXTERNAL_WORKFLOW_DRY_RUN_PILOT.md` | `docs/motor/0860_CODEX_SKILLS_READINESS_REPORT.md`, `docs/motor/0860_CODEX_SKILLS_CHANGED_FILES_PREVIEW.md`, `docs/motor/0860_CODEX_SKILLS_HUMAN_APPROVAL_GATE.md`, `examples/publish_runner/0860_codex_skills_external_dry_run_plan.example.json`, `examples/publish_runner/0860_codex_skills_dry_run_evidence_manifest.example.json`, `tests/unit/test_codex_skills_external_workflow_dry_run_pilot.py` | Quando serve preparare un workflow esterno su `Codex_Skills` senza modificare la repo esterna | read-only/dry-run, readiness report, changed-files preview ipotetica, evidence manifest, `dry_run_only`, `external_repo_write_allowed=false`, `GO_FOR_READ_ONLY_DRY_RUN_COMPLETED`, human gate e prossimo passo `0870) Codex_Skills First Controlled Write Pilot` |
| Eseguire controlled write locale Codex_Skills | `docs/motor/0870_CODEX_SKILLS_FIRST_CONTROLLED_WRITE_PILOT.md` | `docs/motor/0870_CODEX_SKILLS_CONTROLLED_WRITE_RESULT.md`, `docs/motor/0870_CODEX_SKILLS_ROLLBACK_PLAN.md`, `examples/publish_runner/0870_codex_skills_controlled_write_evidence.example.json`, `tests/unit/test_codex_skills_first_controlled_write_pilot.py` | Quando serve validare una micro-modifica documentale locale su `Codex_Skills` dopo guardrail positivi | local-only controlled write, rollback plan, human gate, `external_repo_write_performed`, `external_repo_commit_performed=false`, nessun commit/push/PR/merge/deploy/tag e prossimo passo `0880) Codex_Skills Controlled Write Review and Rollback/Commit Decision` |
| Preparare decisione rollback/commit Codex_Skills | `docs/motor/0880_CODEX_SKILLS_CONTROLLED_WRITE_REVIEW_AND_DECISION.md` | `docs/motor/0880_CODEX_SKILLS_EXTERNAL_REPO_STATE_REPORT.md`, `docs/motor/0880_CODEX_SKILLS_DECISION_MATRIX.md`, `docs/motor/0880_CODEX_SKILLS_PREPARED_COMMANDS_NOT_EXECUTED.md`, `examples/publish_runner/0880_codex_skills_controlled_write_review_decision.example.json`, `tests/unit/test_codex_skills_controlled_write_review_decision.py` | Quando serve decidere cosa fare del file locale 0870 senza ancora eseguire azioni | decision_pack_created, default_recommendation, rollback default, keep local temporaneo, future controlled commit, prepared_commands_executed=false, nessuna scrittura esterna e prossimo passo `0890) Codex_Skills Rollback or Controlled Commit Execution` |
| Eseguire commit locale controllato Codex_Skills | `docs/motor/0890_CODEX_SKILLS_CONTROLLED_LOCAL_COMMIT_EXECUTION.md` | `docs/motor/0890_CODEX_SKILLS_CONTROLLED_LOCAL_COMMIT_RESULT.md`, `examples/publish_runner/0890_codex_skills_controlled_local_commit_evidence.example.json`, `tests/unit/test_codex_skills_controlled_local_commit_execution.py` | Quando Alberto approva esplicitamente il commit locale del file pilota 0870 in `Codex_Skills` | decisione umana B, `local_commit_completed`, `external_repo_commit_performed=true`, `external_repo_push_performed=false`, human gate per push futuro e prossimo passo `0900) Codex_Skills Controlled Push or Rollback Decision` |
| Preparare decisione push/rollback Codex_Skills | `docs/motor/0900_CODEX_SKILLS_CONTROLLED_PUSH_OR_ROLLBACK_DECISION.md` | `docs/motor/0900_CODEX_SKILLS_PUSH_ROLLBACK_STATE_REPORT.md`, `docs/motor/0900_CODEX_SKILLS_PUSH_ROLLBACK_DECISION_MATRIX.md`, `docs/motor/0900_CODEX_SKILLS_PREPARED_COMMANDS_NOT_EXECUTED.md`, `examples/publish_runner/0900_codex_skills_push_or_rollback_decision.example.json`, `tests/unit/test_codex_skills_push_or_rollback_decision.py` | Quando serve decidere cosa fare del commit locale `b488745` senza ancora eseguire azioni | decision_pack_created, push_performed_in_0900=false, rollback_performed_in_0900=false, prepared_commands_executed=false, human gate e prossimo passo `0910) Codex_Skills Controlled Push Execution or Local Rollback` |
| Registrare closure evidence push Codex_Skills | `docs/motor/0920_CODEX_SKILLS_REMOTE_VERIFICATION_AND_EVIDENCE_CLOSURE.md` | `docs/motor/0920_CODEX_SKILLS_REMOTE_PUSH_EVIDENCE_REPORT.md`, `examples/publish_runner/0920_codex_skills_remote_verification_evidence.example.json`, `tests/unit/test_codex_skills_remote_verification_evidence_closure.py` | Quando serve chiudere in ASF il primo push reale controllato su repo esterna completato nello step 0910A-3 | push_completed=true, push_exit_code=0, `36b065d..bec96ff main -> main`, path via `$env:USERPROFILE`, no-fetch/no-pull e prossimo passo `0930) External Repo Push Pattern Generalization` |
| Riparare regressione publish runner PowerShell | `docs/motor/0921_PUBLISH_RUNNER_POWERSHELL_COMPATIBILITY_REGRESSION_FIX.md` | `scripts/asf_publish_step.ps1`, `scripts/asf_minimal_docx.py`, `examples/publish_runner/0921_publish_runner_regression_fix_evidence.example.json`, `tests/unit/test_publish_runner_powershell_compat_regression_fix.py` | Quando il full pytest blocca correttamente una pubblicazione ASF per regressioni runner | safe PSNativeCommandUseErrorActionPreference handling, valid DOCX bridge output, PrepareConfig command argument normalization, state hook event preservation e prossimo passo `0920 publish retry after 0921 fix` |
| Gestire `gh pr checks` senza check riportati | `docs/motor/0922_PUBLISH_RUNNER_GH_CHECKS_NO_CHECKS_REPORTED_FALLBACK.md` | `scripts/asf_publish_step.ps1`, `tests/unit/test_asf_publish_step_gh_checks_fallback.py` | Quando `gh pr checks --watch` restituisce `no checks reported` ma servono evidenze remote alternative | warning esplicito, fallback `gh run list --commit <headSha>`, run `completed/success`, fail-closed senza evidenza e prossimo passo `0930) External Repo Push Pattern Generalization` |
| Gestire warning Git LF/CRLF e info pull nel publish runner | `docs/motor/0923_PUBLISH_RUNNER_LF_CRLF_WARNING_STDERR_HANDLING.md` | `scripts/asf_publish_step.ps1`, `tests/unit/test_asf_publish_step_lf_crlf_warning_handling.py`, `tests/unit/test_asf_publish_step_native_guardrails.py` | Quando `git diff --check`, path discovery Git o Phase C `git pull --ff-only origin main` scrivono stderr sicuro con exit code 0 | `stderr warning treated as non-blocking`, `Pull main stderr info treated as non-blocking`, `LF will be replaced by CRLF`, `CRLF will be replaced by LF`, `Git command wrote unexpected stderr`, exit code non zero bloccante e prossimo passo `0930) External Repo Push Pattern Generalization` |
...
- Non generare o leggere file `LAST-*` come artifact permanenti di repository; eccezione solo per mirror operativi Bridge standard. Per trovare l'ultimo artefatto durabile usare `max(II)` per `(step, tipo)`.
...
- I command pack devono usare guardrail nativi: `ArgList` non vuoto, `AllowedExitCodes`, `ProcessStartInfo.ArgumentList` e successo solo dopo exit code ammesso.
...
- `docs/motor/0800_POWERSHELL_NATIVE_COMMAND_GUARDRAIL_HARDENING.md`: hardening dei comandi nativi PowerShell, `PrNumber`, scope check e no false `COMPLETATO`.
- `docs/motor/0805_POWERSHELL_PUBLISH_SKILL_SYNC_WITH_PROVEN_RUNNER_FLOW.md`: sincronizzazione skill/template sul flusso publish ASF provato con config JSON e runner.
- `docs/motor/0810_PUBLISH_RUNNER_SCOPE_DISCOVERY_RECOVERY_UX_AND_NO_FALSE_COMPLETED_GUARD.md`: scope discovery `PrepareConfig`, recovery out-of-scope fail-closed, warning LF/CRLF non-path e DOCX/accessori best-effort.
- `docs/motor/0820_BRIDGE_OUTPUT_RETRY_FALLBACK_AND_LAST_VALIDATION.md`: retry/fallback per output Bridge e `LAST-*`, compatto Markdown obbligatorio, DOCX best-effort e ownership singolo degli output runner.
- `docs/motor/0830_MVP_REAL_STEP_PILOT_4_SLIGHTLY_MORE_OPERATIONAL.md`: pilot operativo post-0820 con manifest JSON, test dedicato, uso prudente di `PrepareConfig` e handoff verso 0840.
- `docs/motor/0840_RUNNER_HOOK_EVIDENCE_MANIFEST_POST_PUBLISH_PACK.md`: pack post-publish per consolidare PR, merge commit, checks finali, Bridge outputs, LAST files, warning accettati, manifest/evidence e next step.
- `docs/motor/0850_FIRST_REAL_EXTERNAL_WORKFLOW_PILOT.md`: pack preparatorio del primo pilot esterno controllato, con scelta repo, safety boundaries, human gate e manifest planning-only.
- `docs/motor/0860_CODEX_SKILLS_EXTERNAL_WORKFLOW_DRY_RUN_PILOT.md`: dry-run esterno controllato su `Codex_Skills`, con vincoli read-only, readiness, risk assessment, changed-files preview, human gate ed evidence manifest.
- `docs/motor/0860_CODEX_SKILLS_READINESS_REPORT.md`: report di readiness read-only per `Codex_Skills`.
- `docs/motor/0860_CODEX_SKILLS_CHANGED_FILES_PREVIEW.md`: preview ipotetica dei file candidati per un futuro 0870, senza modifiche esterne.
- `docs/motor/0860_CODEX_SKILLS_HUMAN_APPROVAL_GATE.md`: gate umano per decidere se procedere oltre il dry-run.
- `docs/motor/0870_CODEX_SKILLS_FIRST_CONTROLLED_WRITE_PILOT.md`: primo write pilot locale su `Codex_Skills`, documentale, non funzionale e non pubblicante.
- `docs/motor/0870_CODEX_SKILLS_CONTROLLED_WRITE_RESULT.md`: result report del write locale, con status prima/dopo e conferma no publish.
- `docs/motor/0870_CODEX_SKILLS_ROLLBACK_PLAN.md`: piano di rollback manuale del file locale creato in `Codex_Skills`.
- `docs/motor/0880_CODEX_SKILLS_CONTROLLED_WRITE_REVIEW_AND_DECISION.md`: review decisionale del file 0870, con default rollback e criteri per commit futuro.
- `docs/motor/0880_CODEX_SKILLS_EXTERNAL_REPO_STATE_REPORT.md`: stato read-only osservato di `Codex_Skills` dopo il pilot 0870.
- `docs/motor/0880_CODEX_SKILLS_DECISION_MATRIX.md`: matrice A/B/C tra rollback, keep local e future controlled commit.
- `docs/motor/0880_CODEX_SKILLS_PREPARED_COMMANDS_NOT_EXECUTED.md`: comandi rollback/commit preparati ma non eseguiti.
- `docs/motor/0890_CODEX_SKILLS_CONTROLLED_LOCAL_COMMIT_EXECUTION.md`: esecuzione del commit locale controllato su `Codex_Skills` dopo decisione umana B.
- `docs/motor/0890_CODEX_SKILLS_CONTROLLED_LOCAL_COMMIT_RESULT.md`: result report del commit locale, con status prima/dopo e conferma no publish.
- `docs/motor/0900_CODEX_SKILLS_CONTROLLED_PUSH_OR_ROLLBACK_DECISION.md`: decision pack read-only per scegliere push, rollback o keep local del commit `b488745`.
- `docs/motor/0900_CODEX_SKILLS_PUSH_ROLLBACK_STATE_REPORT.md`: stato read-only di `Codex_Skills` dopo il commit locale 0890.
- `docs/motor/0900_CODEX_SKILLS_PUSH_ROLLBACK_DECISION_MATRIX.md`: matrice A/B/C tra push controllato, rollback locale e keep local temporaneo.
- `docs/motor/0900_CODEX_SKILLS_PREPARED_COMMANDS_NOT_EXECUTED.md`: comandi push/rollback/monitoraggio preparati ma non eseguiti.
- `docs/motor/0920_CODEX_SKILLS_REMOTE_VERIFICATION_AND_EVIDENCE_CLOSURE.md`: closure pack del primo push reale controllato su `Codex_Skills`.
- `docs/motor/0920_CODEX_SKILLS_REMOTE_PUSH_EVIDENCE_REPORT.md`: evidence report post-push con status pulito, tracking locale allineato e nota no-fetch/no-pull.
- `docs/motor/0921_PUBLISH_RUNNER_POWERSHELL_COMPATIBILITY_REGRESSION_FIX.md`: fix regressione publish runner PowerShell emersa durante la pubblicazione 0920.
...
- `scripts/asf_minimal_docx.py`: helper Python standard library per creare DOCX minimi validi quando il runner non puo' usare `ZipArchive`.
...
- `scripts/asf_publish_step.ps1`: runner STEP 0590/0640/0810/0820 per `PrepareConfig` e FASE A/B/C di pubblicazione step con comando corto, config JSON, Bridge output retry/fallback, flag espliciti, scope discovery/recovery e validazione opzionale del verification profile.
...
- `examples/publish_runner/0830_prepare_config_pilot.json`: manifest dimostrativo del pilot 0830, non una config pronta a pubblicare automaticamente.
- `examples/publish_runner/0840_post_publish_evidence_manifest.example.json`: manifest esempio post-publish derivato dal riepilogo 0830, non evidence live generata automaticamente.
- `examples/publish_runner/0850_external_workflow_pilot_plan.example.json`: manifest esempio planning-only per il primo pilot esterno controllato, non pubblicante.
- `examples/publish_runner/0860_codex_skills_external_dry_run_plan.example.json`: dry-run plan esempio per `Codex_Skills`, read-only e non pubblicante.
- `examples/publish_runner/0860_codex_skills_dry_run_evidence_manifest.example.json`: evidence manifest esempio del dry-run 0860, con conferma di nessuna scrittura esterna.
- `examples/publish_runner/0870_codex_skills_controlled_write_evidence.example.json`: evidence manifest esempio del controlled write 0870, con write locale documentale e nessuna pubblicazione Git.
- `examples/publish_runner/0880_codex_skills_controlled_write_review_decision.example.json`: evidence manifest esempio della review 0880, con decision options e comandi non eseguiti.
- `examples/publish_runner/0890_codex_skills_controlled_local_commit_evidence.example.json`: evidence manifest esempio del commit locale controllato 0890, senza push/PR/merge/deploy/tag.
- `examples/publish_runner/0900_codex_skills_push_or_rollback_decision.example.json`: evidence manifest esempio del decision pack 0900, senza push/rollback/commit/PR/merge/deploy/tag.
- `examples/publish_runner/0920_codex_skills_remote_verification_evidence.example.json`: evidence manifest esempio della closure 0920 con push_completed=true, push_exit_code=0 e guardrail no-fetch/no-pull.
- `examples/publish_runner/0921_publish_runner_regression_fix_evidence.example.json`: evidence manifest esempio del fix runner 0921, senza pubblicazione.
- `docs/motor/0922_PUBLISH_RUNNER_GH_CHECKS_NO_CHECKS_REPORTED_FALLBACK.md`: policy runner per `gh pr checks --watch` con `no checks reported`, fallback `gh run list --commit <headSha>` e fail-closed senza run success.
- `docs/motor/0923_PUBLISH_RUNNER_LF_CRLF_WARNING_STDERR_HANDLING.md`: policy runner per warning Git LF/CRLF su stderr, whitelist stretta con exit code 0 e fail-closed su stderr inatteso.
- `docs/adr/0940_SUPERVISED_LOOP_ARCHITECTURE_WITH_POWERSHELL_FAST_LANE_AND_RECOVERY.md`: decisione architetturale sulle lane supervised loop ASF V1.
- `docs/motor/0940_SUPERVISED_LOOP_ARCHITECTURE.md`: ciclo end-to-end supervisionato e ruoli.
- `docs/motor/0940_POWERSHELL_FAST_LANE_SPEC.md`: lane deterministica PowerShell per task rapidi e verificabili.
- `docs/motor/0940_POWERSHELL_RECOVERY_LOOP_SPEC.md`: recovery loop con watchdog, failure class e retry policy.
- `docs/motor/0940_SUPERVISED_LOOP_STATE_MACHINE.md`: stati, semafori e struttura minima `state.json`.
- `docs/motor/0940_SUPERVISED_LOOP_ROADMAP.md`: roadmap 0950-1010 verso il loop supervisionato completo.
- `docs/templates/0940_SUPERVISED_LOOP_STEP_PLAN_TEMPLATE.md`: template step plan supervised loop.
- `docs/templates/0940_POWERSHELL_TASK_ENVELOPE_TEMPLATE.md`: template envelope task PowerShell Fast Lane.
- `docs/runbooks/0940_SUPERVISED_LOOP_OPERATOR_RUNBOOK.md`: runbook operatore per Alberto.
- `docs/motor/0980_GPT_PROMPT_GENERATOR_API_ADAPTER.md`: adapter prompt GPT mock-first con output `PROMPT_READY`.
- `docs/motor/0990_CODEX_EXEC_RUNNER_ADAPTER.md`: adapter Codex exec dry-run con output `CODEX_DRY_RUN_DONE`.
- `docs/motor/1000_AUTO_REVIEW_AND_STEP_DECISION_POLICY.md`: policy deterministica `PASS/FIX/STOP/ASK_ALBERTO`.
- `docs/motor/1010_FINAL_END_TO_END_SMOKE_TEST.md`: smoke `1010-smoke-docs-step` fino a `COMPLETED`.
- `docs/templates/0980_GPT_PROMPT_REQUEST_TEMPLATE.json`: template input prompt generator.
- `docs/templates/0990_CODEX_EXEC_ENVELOPE_TEMPLATE.json`: template envelope Codex dry-run.
- `docs/templates/1000_STEP_DECISION_INPUT_TEMPLATE.json`: template input decision policy.
- `docs/templates/1010_SUPERVISED_LOOP_SMOKE_STATE_TEMPLATE.json`: template stato smoke 1010.
