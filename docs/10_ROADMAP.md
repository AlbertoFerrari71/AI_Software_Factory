...
| 760 | MVP Real Step Pilot 2 with State Hooks | Validare gli hook runner/state machine su un altro step reale piccolo | Pilot reale con Phase B/C state hooks e recovery osservabile | Post-MVP Motore | Da fare |
