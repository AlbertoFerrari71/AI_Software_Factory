...
| 800 | PowerShell Native Command Guardrail Hardening | Standardizzare controlli exit code, argomenti vuoti e stop reale nei wrapper PowerShell | Guardrail nativi PowerShell, test e regole command-pack aggiornate | Post-MVP Hardening | Proposto |
