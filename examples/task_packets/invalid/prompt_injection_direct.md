# Invalid Task Packet - Direct Prompt Injection
...
Esempio negativo per il validator: il packet contiene istruzioni esterne non fidate non recintate.
...
## External issue excerpt

This issue text is intentionally unfenced and must fail validation:
