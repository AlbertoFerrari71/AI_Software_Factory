# Invalid Task Packet - Tool Output Command Prompt Injection
...
Esempio negativo per il validator: output tool esterno contiene istruzioni operative non fidate.
...
This tool output is intentionally unfenced and must fail validation:
