...
def check_files(root: Path) -> list[HealthIssue]:
    required_paths = [
        ...
        "tests/unit/test_asf_latest_report_resolver.py",
        "tests/unit/test_asf_operator_tools.py",
        "tests/unit/test_asf_risk_classifier_eval.py",
...
def check_project_workflow_index(root: Path) -> list[HealthIssue]:
    return check_required_fragments(
        ...
        requirements=[
            ...
            (
                "ASF PowerShell Publish Skill Sync pointers",
                [
                    "docs/motor/0805_POWERSHELL_PUBLISH_SKILL_SYNC_WITH_PROVEN_RUNNER_FLOW.md",
            ...
            (
                "ASF Runner Hook Evidence Manifest Post-Publish Pack document",
                ["docs/motor/0840_RUNNER_HOOK_EVIDENCE_MANIFEST_POST_PUBLISH_PACK.md"],
            ),
            (
                "ASF Runner Hook Evidence Manifest Post-Publish Pack pointers",
                [
                    "examples/publish_runner/0840_post_publish_evidence_manifest.example.json",
            ...
            (
                "ASF Codex_Skills First Controlled Write Pilot pointers",
                [
                    "docs/motor/0870_CODEX_SKILLS_FIRST_CONTROLLED_WRITE_PILOT.md",
                    "docs/motor/0870_CODEX_SKILLS_CONTROLLED_WRITE_RESULT.md",
                    "docs/motor/0870_CODEX_SKILLS_ROLLBACK_PLAN.md",
            ...
            (
                "ASF Publish Runner LF CRLF Warning Stderr Handling pointers",
                [
                    "docs/motor/0923_PUBLISH_RUNNER_LF_CRLF_WARNING_STDERR_HANDLING.md",
                    "tests/unit/test_asf_publish_step_lf_crlf_warning_handling.py",
            ...
            (
                "ASF Supervised Loop 0940 pointers",
                [
                    "docs/adr/0940_SUPERVISED_LOOP_ARCHITECTURE_WITH_POWERSHELL_FAST_LANE_AND_RECOVERY.md",
                    "docs/motor/0940_SUPERVISED_LOOP_ARCHITECTURE.md",
                    "docs/motor/0940_POWERSHELL_FAST_LANE_SPEC.md",
            ...
            (
                "ASF Supervised Loop 0945-0970 foundation pointers",
                [
                    "docs/motor/0945_ADAPTIVE_VERIFICATION_PROFILES.md",
                    "docs/motor/0950_BRIDGE_STATE_AND_SEMAPHORE_PROTOCOL.md",
                    "docs/motor/0960_POWERSHELL_FAST_TASK_RUNNER.md",
            ...
            (
                "ASF Supervised Loop 0980-1010 AI adapter smoke pointers",
                [
                    "docs/motor/0980_GPT_PROMPT_GENERATOR_API_ADAPTER.md",
                    "docs/motor/0990_CODEX_EXEC_RUNNER_ADAPTER.md",
                    "docs/motor/1000_AUTO_REVIEW_AND_STEP_DECISION_POLICY.md",
            ...
            (
                "ASF Supervised Loop 1020 GPT live controlled pointers",
                [
                    "docs/motor/1020_GPT_PROMPT_GENERATOR_LIVE_CONTROLLED_RUN.md",
                    "docs/templates/1020_GPT_LIVE_CONTROLLED_PLAN_TEMPLATE.json",
                    "docs/templates/1020_GPT_LIVE_CONTROLLED_RESULT_TEMPLATE.json",
            ...
            (
                "ASF Supervised Loop 1030 GPT live continuity pointers",
                [
                    "docs/motor/1030_GPT_LIVE_CONTINUITY_MEGA_STEP.md",
                    "docs/motor/1030_DONE_TRIGGER_SPEC.md",
                    "docs/motor/1030_HANDOFF_AUTOMATION.md",
            ...
            (
                "ASF Supervised Loop 1035 provider response diagnostic pointers",
                [
                    "docs/motor/1035_PROVIDER_RESPONSE_DIAGNOSTIC_SANITIZED_REVIEW.md",
                    "scripts/asf_provider_response_diagnostic.py",
                    "tests/unit/test_asf_provider_response_diagnostic.py",
            ...
            (
                "ASF V1 Supervised Operator RC 1050-1130 pointers",
                [
                    "docs/motor/1050_CONTRACT_COHERENCE_AND_NUMBERING_BASELINE.md",
                    "docs/motor/1060_SECRET_SCANNING_GATE_FOUNDATION.md",
                    "docs/motor/1070_WINDOWS_CI_MATRIX_FOR_POWERSHELL_RUNNER.md",
            ...
            (
                "Prompt Injection Fencing 1140 pointers",
                [
                    "docs/motor/1140_PROMPT_INJECTION_ADVERSARIAL_SAMPLES_AND_FENCING.md",
                    "scripts/validate_task_packet.py",
                    "tests/unit/test_prompt_injection_fencing.py",
            ...
            (
                "Automated Milestone Runner 1200-1290 pointers",
                [
                    "docs/adr/1200_AUTOMATED_MILESTONE_RUNNER.md",
                    "docs/motor/1200_AUTOMATED_MILESTONE_RUNNER_ARCHITECTURE.md",
                    "docs/motor/1200_STATE_MACHINE.md",
